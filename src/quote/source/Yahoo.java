...
public class Yahoo implements PriceReader {
    ...
    public TreeMap<Long, quote.Prices> getPrices(String ticket){
        ...
        try{
            url  = new URL("http://ichart.finance.yahoo.com/table.csv?s="+ticket+"&a=4&b=15&c=2000&d="+calendar.get(Calendar.MONTH)+"&e="+calendar.get(Calendar.DAY_OF_MONTH)+"&f="+calendar.get(Calendar.YEAR)+"&g=d&ignore=.csv");                    
